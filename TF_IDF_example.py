# In bag of words we are only getting count of occurences of each word in each sentence,
# which is not an efficient way of NLP.

# in this file, we are going to look at TF IDF which is known as Term Frequency, Inverse Document Frequency

# There will be two tables represented by TF and IDF collectively.

# TF = number of each word present in a sentence divide by total number of words in a sentence.
